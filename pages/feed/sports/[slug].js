...
const Sports = ({ pageNumber, articles }) => {
...
export const getServerSideProps = async (pageContext) => {
	...
	const apiResponse = await fetch(
		`https://newsapi.org/v2/top-headlines?country=kr&category=sports&pageSize=5&page=${pageNumber}&apiKey=${process.env.NEWS_API_KEY}`
	);
